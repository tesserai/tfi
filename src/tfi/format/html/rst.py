...
from docutils.transforms import universal, frontmatter
...
class _DocutilsSettings(object):
    def __init__(self, citation_label_by_refname, bibtex_entries_by_refname):
        ...
        self.pep_references = True
        self.rfc_references = True
        self.id_prefix = 'prefix-'
        self.auto_id_prefix = 'auto-'
        self.trim_footnote_reference_space = True
        self.xml_declaration = '1'
        self.output_encoding = 'utf-8'
        self.stylesheet = ''
        self.stylesheet_path = ''
        self.initial_header_level = 1
        self.math_output = 'html'
...
from tfi.format.html.bibtex import citation_hover_html

class _HTMLTranslator(nodes.NodeVisitor):
    ...
    def visit_subtitle(self, node):
        if isinstance(node.parent, nodes.sidebar):
            ...
            classes = 'subtitle'
            self.in_document_title = len(self.body) == 0
